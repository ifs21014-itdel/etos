                ...
                <td width="48%">
                    <table >
                        ...
                        <tr>
                            ...
                            <td width="2%" align="center">:</td>
                            <td width="48%">
                                <?php if ($hardness_test_list->rating == 'Passed') echo '<b>X</b>'; ?>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%">FAIL</td>
                            <td width="2%" align="center">:</td>
                            <td width="48%">
                                <?php if ($hardness_test_list->rating == 'Failed') echo '<b>X</b>'; ?>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%">CAR</td>
                            <td width="2%" align="center">:</td>
                            <td width="48%">
                                <?php if ($hardness_test_list->rating == 'Car') echo '<b>X</b>'; ?>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                        ...
                        <tr>
                            <td height="100"  align="center">
                                <?php if (trim($hardness_test_list->product_image) != ""): ?>
                                    <img src="<?php echo $_SERVER["HTTP_REFERER"] . 'files/hardnesstest/' . $hardness_test_list->id . "/" . $hardness_test_list->product_image; ?>" width="105" height="100">
                                <?php endif; ?>
                            </td>
                        </tr>
                    </table>
                ...
                <td width="48%">
                    <table  width="100%">
                        ...
                        <tr>
                            <td height="100" align="center">
                                <?php echo $hardness_test_list->corrective_action_plan_image; ?>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle; text-align: center;">
                                <?php if (trim($result->image_file) != "") { ?>
                                    <img src="<?php echo $_SERVER["HTTP_REFERER"] . 'files/hardnesstest/' . $result->hardness_test_list_id . "/" . $result->image_file; ?>" style="max-width:50%; height:auto;">
                                <?php } ?>
                            </td>
                        </tr> 
                        <?php
