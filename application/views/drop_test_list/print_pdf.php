...
<html lang="en">
    ...
    <head>
        <style>
            table {
                width: 100%;            /* Optional, sesuaikan dengan kebutuhan */
                border-collapse: collapse;
            }

            /*            table, th, td {
                            border: 1px solid black;
                            padding: 8px;            Memberikan padding agar konten lebih rapi 
                            text-align: left;        Menyelaraskan teks ke kiri 
                        }
            
                        th {
                            background-color: #f2f2f2;   Memberikan warna latar belakang untuk header tabel 
                        }*/
    ...
    <body>
        <table border="1" width="100%">
            <tr>
                ...
                <td align="center"  width="32%"><h3>TEST REPORT</h3></td>
            ...
            <tr>
                <td colspan="3" width="100%">
                    <table width="100%" border=1>
                            ...
                            <td width="48%">
                                <table width="100%" border=1>
                                    ...
                                    <tr>
                                        ...
                                        <td width='2%' align='center'>:</td>
                                        <td width='48%'><?php echo $drop_test_list->product_dimension; ?></td>
                                    </tr>
                                    <tr>
                                        <td width='50%'>Carton Dimension (Inches)</td>
                                        <td width='2%' align='center'>:</td>
                                        <td width='48%'><?php echo $drop_test_list->carton_dimension; ?></td>
                                    </tr>
                                    <tr>
                                        <td width='50%'>Gross Weight (Lbs)</td>
                                        <td width='2%' align='center'>:</td>
                                        <td width='48%'><?php echo $drop_test_list->gross_weight; ?></td>
                                    </tr>
                                    <tr>
                                        <td width='50%'>Nett  Weight (Lbs)</td>
                                        <td width='2%' align='center'>:</td>
                                        <td width='48%'><?php echo $drop_test_list->nett_weight; ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="3">
                                <table celpadding="0" celspacing="0" width="100%" >
                                    <?php
                                    $x = 0;
                        ...
                        <tr>
                            <th bgcolor='#ffff99' colspan="3" align="center">TEST RESULT SUMMARY</th>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <table celpadding="0" celspacing="0" width="100%" >
