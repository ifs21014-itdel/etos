        ...
        <table width="100%" border="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="client_id" id="drop_test_client_id" mode="remote" class="easyui-combogrid" style="width: 100%" required="true"/>
                    <script type="text/javascript">
                        $('#drop_test_client_id').combogrid({
                            panelWidth: 460,
                            idField: 'id',
                            textField: 'name',
                            mode: 'remote',
            ...
            <tr>
                ...
                <td width="70%">
                    ...
                    <input type="text" name="product_id" id="drop_test_product_id" mode="remote" class="easyui-combogrid" style="width: 100%" required="true"/>
                    <script type="text/javascript">
                        $('#drop_test_product_id').combogrid({
                            panelWidth: 460,
                            idField: 'id',
                            mode: 'remote',
                        ...
                        $('#drop_test_vendor_id').combogrid({
                            ...
                            loadFilter: function (data2) {
                                ...
                                $.map(data2.rows, function (row) {
                                    row.drop_test_vendor_text = 'Vendor ID:' + row.id + ':Vendor Name:' + row.name;
                                    row.drop_test_vendor_val = row.id + '#' + row.name;
                                });
                                return data2;
                            },
